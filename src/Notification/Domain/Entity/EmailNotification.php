...
class EmailNotification extends Notification
{
    ...
    public function setEmailSenderName(string $emailSenderName): void
    {
    ...
    public function setEmailSenderEmail(string $emailSenderEmail): void
    {
    ...
    public function getEmailContentPlain(): ?string
    {
        return $this->emailContentPlain;
    }
    public function setEmailContentPlain(?string $emailContentPlain): self
    {
        $this->emailContentPlain = $emailContentPlain;

        return $this;
    }
    public function getEmailContentHtml(): ?string
    {
        return $this->emailContentHtml;
    }
    public function setEmailContentHtml(?string $emailContentHtml): void
    {
        $this->emailContentHtml = $emailContentHtml;
    }
    public function getEmailRecipientsCc(): ?array
    {
        return $this->emailRecipientsCc;
    }
    public function setEmailRecipientsCc(?array $emailRecipientsCc): void
    {
        $this->emailRecipientsCc = $emailRecipientsCc;
    }
    public function getEmailRecipientsBcc(): ?array
    {
        return $this->emailRecipientsBcc;
    }
    public function setEmailRecipientsBcc(?array $emailRecipientsBcc): void
    {
        $this->emailRecipientsBcc = $emailRecipientsBcc;
    }
    public function getEmailRecipientsReplyTo(): ?array
    {
        return $this->emailRecipientsReplyTo;
    }
    public function setEmailRecipientsReplyTo(?array $emailRecipientsReplyTo): void
    {
        $this->emailRecipientsReplyTo = $emailRecipientsReplyTo;
    }
    public function getMediaIdsAttachments(): ?array
    {
        return $this->mediaIdsAttachments;
    }
    public function setMediaIdsAttachments(?array $mediaIdsAttachments): void
    {
        $this->mediaIdsAttachments = $mediaIdsAttachments;
    }
    public function getBinaryAttachments(): ?array
    {
        return $this->binaryAttachments;
    }
    public function setBinaryAttachments(?array $binaryAttachments): void
    {
